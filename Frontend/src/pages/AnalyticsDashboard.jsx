...
const AnalyticsDashboard = () => {
    ...
    const renderSmartLabel = ({ cx, cy, midAngle, outerRadius, percent, name, index }) => {
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {dashboardData.insights.map((insight, index) => (
                                    <div key={index} className={`p-4 rounded-lg border-l-4 ${insight.type === 'positive' ? 'bg-green-50 border-green-400' :
